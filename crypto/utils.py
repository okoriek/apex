...
def SendReferalMail(user,referer):
    ...
    email = EmailMessage(subject=email_subject, body=email_body,
        from_email='Apexfortitude <support@apexfortitude.com>', to=[referer.user.email]
        )
...
def DepositMail(user,amount,currency):
    ...
    email = EmailMessage(subject=email_subject, body=email_body,
        from_email='Apexfortitude <support@apexfortitude.com>', to=[user.email]
        )
    email.content_subtype = 'html'
    email.send()
...
def CommisionMail(user,referer, bonus):
    ...
    email = EmailMessage(subject=email_subject, body=email_body,
        from_email='Apexfortitude <support@apexfortitude.com>', to=[referer.email]
        )
    email.content_subtype = 'html'
    email.send()
